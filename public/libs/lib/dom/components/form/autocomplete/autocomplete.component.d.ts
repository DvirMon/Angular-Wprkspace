...
export declare class AutocompleteComponent<T> {
  ...
  optionTemplate: import('@angular/core').InputSignal<
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<
    ...
    never,
    {
      ...
      defaultValue: { alias: 'defaultValue'; required: false; isSignal: true };
      options: { alias: 'options'; required: true; isSignal: true };
      control: { alias: 'control'; required: true; isSignal: true };
      optionTemplate: {
        alias: 'optionTemplate';
        required: false;
        isSignal: true;
      };
      displayFn: { alias: 'displayFn'; required: false };
    },
    { queryChanged: 'queryChanged'; optionSelected: 'optionSelected' },
