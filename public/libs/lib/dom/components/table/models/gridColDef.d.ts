...
export type GridValueGetter<R extends GridValidRowModel = GridValidRowModel, V = unknown, F = V, TValue = never> = (value: TValue, row: R, column: GridColDef<R, V, F>) => V;
export type GridValueFormatter<R extends GridValidRowModel = GridValidRowModel, V = unknown, F = V, TValue = never> = (value: TValue, row: R, column: GridColDef<R, V, F>) => F;
export type GridValueSetter<R extends GridValidRowModel = GridValidRowModel, V = unknown, F = V> = (value: V, row: R, column: GridColDef<R, V, F>) => R;
export type GridValueParser<R extends GridValidRowModel = GridValidRowModel, V = unknown, F = V> = (value: F | undefined, row: R | undefined, column: GridColDef<R, V, F>) => V;
export type GridColSpanFn<R extends GridValidRowModel = GridValidRowModel, V = unknown, F = V> = (value: V, row: R, column: GridColDef<R, V, F>) => number | undefined;
/**
 * Column Definition base interface.
 */
export interface GridBaseColDef<R extends GridValidRowModel = GridValidRowModel, V = unknown, F = V> {
    /**
 ...
 */
export interface GridActionsColDef<R extends GridValidRowModel = {
    [key: string]: unknown;
}, V = unknown, F = V> extends GridBaseColDef<R, V, F> {
    /**
     * The type of the column.
     * @default 'actions'
     */
 ...
 *   - [Special column properties](/x/react-data-grid/column-definition/#special-properties)
 */
export interface GridSingleSelectColDef<R extends GridValidRowModel = {
    [key: string]: unknown;
}, V = unknown, F = V> extends GridBaseColDef<R, V, F> {
    /**
     * The type of the column.
 ...
 */
export type GridColDef<R extends GridValidRowModel = {
    [key: string]: unknown;
}, V = unknown, F = V> = GridBaseColDef<R, V, F> | GridActionsColDef<R, V, F> | GridSingleSelectColDef<R, V, F>;
export type GridColTypeDef<V = unknown, F = V> = Omit<GridBaseColDef<{
    [key: string]: unknown;
}, V, F>, 'field'>;
export interface GridValueOptionsParams<R extends GridValidRowModel = {
    [key: string]: unknown;
}> {
    /**
