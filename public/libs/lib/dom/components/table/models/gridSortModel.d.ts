...
export interface GridSortCellParams<V = unknown> {
    id: GridRowId;
    field: string;
    value: V;
 ...
 */
export type GridComparatorFn<V = unknown> = (v1: V, v2: V, cellParams1: GridSortCellParams<V>, cellParams2: GridSortCellParams<V>) => number;
/**
